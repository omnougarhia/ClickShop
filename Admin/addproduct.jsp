            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <% if(success!=null) { %>
                            <span class="text-center text-danger"><%= success %></span>
                            <% } %>
                    </div>
                        ...
                        <div class="col-xl-12 col-md-6 mb-4">
                            ...
                            <form action="addproduct.do" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  class="form-control" name="description" id="decription" aria-describedby="emailHelp" rows="4" cols="50"> </textarea>
                                </div>
                                <div class="form-group">
